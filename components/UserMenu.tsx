          ...
          <div>
            ...
            >
              ...
              <Image
                ...
                src={
                  session?.user?.avatar ? session.user.avatar : "/Avatar.png"
                }
                alt="User avatar"
                width={32}
                height={32}
              />
              <span className="ml-2 text-white hover:text-opacity-80 transition-all duration-300 ease-in-out">
          ...
          <AnimatePresence>
            {userMenuOpen && (
              <motion.div
                ...
                className="origin-top-right absolute right-0 mt-2 w-48 rounded-md border border-blue-700 shadow-lg py-1 bg-white bg-opacity-5 ring-1 ring-black ring-opacity-5 focus:outline-none"
              >
                {session ? (
                  <>
                    <Link
                  ...
                  <>
                    <button
                      onClick={() => signIn()}
                      className="flex items-center w-full text-left px-4 py-2 text-base font-semibold text-green-500 hover:text-opacity-80 transition-colors duration-150"
                    >
